...
namespace InventoryManagement
{
    public partial class ModifyProductForm : Form
    {
        ...
        {
            NewProduct.AssociatedParts = selectedProduct.AssociatedParts;
            CandidateParts = new BindingList<Part>(Inventory.AllParts.Except(NewProduct.AssociatedParts).ToList());
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            if (selectedProduct.ProductID != productID &&
                ...
                Inventory.Products.Any(p => p.ProductID == productID))
            {
                MessageBox.Show("Product ID must be the same as before or unique.");
                return;
            }
            ...
            Inventory.UpdateProduct(selectedProduct.ProductID, NewProduct);
        ...
        private void AssociatedPartsSearchBar_TextChanged(object sender, EventArgs e)
        {
